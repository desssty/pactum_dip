...
import { User, BookOpen, History, Wallet, ChevronRight } from "lucide-react";
import { cn } from "@/lib/utils";

const links = [
  { href: "/client/profile", label: "Мой профиль", icon: User },
  { href: "/client/bookings", label: "Записи", icon: BookOpen },
